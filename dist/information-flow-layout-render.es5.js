...
var configWrapCreate$2 = function (winWidth, customStyles) {
    return Object.assign({}, defaultWrapConfig$2, {
        width: winWidth,
        height: (winWidth * 100 / 320) * 33 / 50 + spacingMd$1 + spacingSm * 4,
    }, customStyles);
};
/**
 * img 样式
...
var InformationFlowLayoutRender = (function () {
    function InformationFlowLayoutRender() {
    ...
    InformationFlowLayoutRender.prototype.render = function (dom, data) {
        var _this = this;
    ...
    InformationFlowLayoutRender.prototype.renderBigImgItem = function (container, adItem) {
        ...
        // img container
        var imgContentDom = this.buildDom("div", {}, function () { return bigImgStyle.configImgContainerCreate(winWidth); });
    ...
    InformationFlowLayoutRender.prototype.renderImgTextItem = function (container, adItem) {
         ...
         * 左侧图片
         */
        var imgDom = this.buildDom("div", {}, function () { return imgTextStyle.configImgCreate(winWidth); });
         ...
         * 右侧内容
         */
        var rightContent = this.buildDom("div", {}, function () { return imgTextStyle.configRightCreate(winWidth); });
        /**
         * title 相关
         */
        var titleWrapDom = this.buildDom("div", {}, function () { return imgTextStyle.configTitleWrapCreate(winWidth); });
        var titleDom = this.buildDom("span", {
            innerText: title,
        ...
        if (type === InformationFlowLayoutRender.remarkType.SHOW_DESC && desc) {
            var descDom = this.createDescDom(desc, 15, 0);
            rightContent.appendChild(descDom);
        }
        else if (type === InformationFlowLayoutRender.remarkType.SHOW_SRC_TIME && src && time) {
            var srcAndTimeDom = this.createSrcAndTimeDom(src, time, 0, 0, 20);
    ...
    InformationFlowLayoutRender.prototype.renderImgsItem = function (container, adItem) {
        ...
        var _loop_1 = function (i) {
            ...
            var imgItem = this_1.buildDom("div", {}, function () { return imgsStyle.configImgItemCreate(winWidth, customStyle, imgLen); });
    ...
    InformationFlowLayoutRender.prototype.createLineDom = function (top, position) {
        var _this = this;
        var lineDom = this.buildDom("div", {}, function () { return configCreate(_this.winWidth, {
            top: top,
            position: position
        }); });
        return lineDom;
    ...
    InformationFlowLayoutRender.prototype.createSrcAndTimeDom = function (src, time, top, left, height) {
        ...
        var itemStyles = srcTimeStyles.configItemCreate(this.winWidth, { "line-height": height });
...
export default InformationFlowLayoutRender;
